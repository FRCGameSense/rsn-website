...
export const ty_tremblay: Member = {
  first: 'Ty',
  last: 'Tremblay',
  bio: 'Ty Tremblay is an FRC alumnus and mentor, having been involved with the program since 2004. He has been a mentor for teams 319, 190, and 2713, and has been a volunteer in various roles at events across New England. Ty has developed several useful software tools for FRC, including QR Scout and FRCVideoSplitter. He is currently Senior Manager of Web Appliacations at Realtime Robotics.',
  image: '/images/members/ty_tremblay.jpg',
};
